...
#define MRP_TYPE_TASK_VIRTUAL_TYPE     (mrp_task_type_get_virtual_type ())
...
typedef enum {
	MRP_TASK_TYPE_NORMAL = 0,
	MRP_TASK_TYPE_MILESTONE = 2
} MrpTaskType;

typedef enum {
	MRP_TASK_TYPE_ACTUAL = 0,
	MRP_TASK_TYPE_VIRTUAL = 1,
} MrpTaskVirtualType;
